...
import { RoutesDataItem, BreadcrumbType, PathJsonRoutesDataItem, vueRoutes, jsonPathVueRoutes, getJsonRouteItem, getBreadcrumbRoutes } from '@/corePage/utils/routes'
...
import LayoutRoutes from '../menusData/index'
